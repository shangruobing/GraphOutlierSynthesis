...
python main.py --method "GNNOutlier" --backbone "gcn" --device 0 --dataset "twitch" --epochs 100 --lower_bound_id -3 --upper_bound_id -10 --num_layers 3
...
python main.py --method "GNNOutlier" --backbone "gcn" --device 0 --dataset "arxiv" --epochs 100 --lower_bound_id -2 --upper_bound_id -3 --num_layers 2
